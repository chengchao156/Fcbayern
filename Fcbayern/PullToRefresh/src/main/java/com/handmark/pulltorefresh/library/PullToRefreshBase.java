...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	@Override
	public final void setRefreshing(boolean pullFromStart) {
		setRefreshing(pullFromStart, true);
	}

	@Override
	public final void setRefreshing(boolean pullFromStart, boolean doScroll) {
		if (!isRefreshing()) {
			mCurrentMode = pullFromStart ? Mode.PULL_FROM_START : Mode.PULL_FROM_END;
